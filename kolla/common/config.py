...
DELOREAN = \
    "https://trunk.rdoproject.org/centos7-pike/current-passed-ci/delorean.repo"
...
SOURCES = {
    ...
    'cinder-base': {
        ...
        'location': ('$tarballs_base/cinder/'
                     'cinder-11.2.2.tar.gz')},
    'congress-base': {
        'type': 'url',
        'location': ('$tarballs_base/congress/'
                     'openstack-congress-6.0.2.tar.gz')},
    'cloudkitty-base': {
        'type': 'url',
        'location': ('$tarballs_base/cloudkitty/'
                     'cloudkitty-6.0.1.tar.gz')},
    'designate-base': {
        'type': 'url',
        'location': ('$tarballs_base/designate/'
                     'designate-5.0.3.tar.gz')},
    'dragonflow-base': {
        'type': 'url',
    ...
    'freezer-api': {
        ...
        'location': ('$tarballs_base/freezer-api/'
                     'freezer-api-5.0.1.tar.gz')},
    'freezer-base': {
        'type': 'url',
        'location': ('$tarballs_base/freezer/'
                     'freezer-5.0.1.tar.gz')},
    'glance-base': {
        'type': 'url',
        'location': ('$tarballs_base/glance/'
                     'glance-15.0.2.tar.gz')},
    'gnocchi-base': {
        'type': 'git',
        'reference': '4.1.2',
    ...
    'monasca-api': {
        ...
        'location': ('$tarballs_base/monasca-api/'
                     'monasca-api-2.2.1.tar.gz')},
    'monasca-log-api': {
        'type': 'url',
        'location': ('$tarballs_base/monasca-log-api/'
                     'monasca-log-api-2.3.1.tar.gz')},
    ...
    'monasca-persister': {
        ...
        'location': ('$tarballs_base/monasca-persister/'
                     'monasca-persister-1.7.1.tar.gz')},
    'monasca-statsd': {
        'type': 'url',
